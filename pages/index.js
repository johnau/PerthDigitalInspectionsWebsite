            ...
            <Box sx={{ minWidth: 700 }}>
                ...
                <Stack spacing={0} sx={{ bgcolor: "background.dark" }}>
                    <Box sx={{ py: 10 }}>
                        ...
                        */}
                        <Box id="stick_A" sx={{ position: "relative", width: "100%", height: (titleContentGap + vrTourSectionHeight) }}>
                            {/* <Box id="stick_B" sx={{ position: 'absolute', top: titleContentGap, width: "100%", justifyContent: 'center' }}> */}
                            <Box id="stick_B" sx={{ position: 'absolute', width: "100%", justifyContent: 'center' }}>
                                ...
                                <StickForAWhile stickHeight={400} backgroundColor="#fff">
                                    <SizeChange2Step contentHeight={550} wid1={0.33} wid2={0.66} wid3={1.0}>
                                        {/* <HeightChange2Step hgt1='33%' hgt2='66%' hgt3='100%'> */}
                                        <FocusFade offset={focusFadeOffset}>
                                            <TopExitFade offset={50}>
